@extends('layouts.app')
@section('title', 'Jelszó modsítása')

@section('content')
<div class="flex justify-center items-center h-screen">
    <div class="p-10 w-96 bg-white rounded-lg border border-gray-200 shadow-md sm:p-6 lg:p-8 dark:bg-gray-800 dark:border-gray-700">
        <form class="space-y-6" method="POST" action="{{ route('password.update') }}">
            @csrf
            <h3 class="text-2xl text-center text-gray-900 dark:text-white my-2">Jelszó módosítása</h3>
            <div>
